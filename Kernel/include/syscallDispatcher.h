...
typedef uint64_t (*syscall_t)(uint64_t p1, uint64_t p2, uint64_t p3, uint64_t p4, uint64_t p5, uint64_t p6,
...
uint64_t clearScreenHandler(uint64_t firstP, uint64_t secondP, uint64_t thirdP,
                            uint64_t fourthP, uint64_t fifthP, uint64_t sixthP, uint64_t seventhP, uint64_t eighthP);
...
uint64_t createProcessHandler(uint64_t entryPoint, uint64_t foreground, uint64_t thirdP,
                              uint64_t fourthP, uint64_t fifthP, uint64_t sixthP, uint64_t seventhP, uint64_t name);
