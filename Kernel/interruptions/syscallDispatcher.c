...
uint64_t memDumpHandler(uint64_t dir, uint64_t dump, uint64_t thirdP, uint64_t fourthP, uint64_t fifthP) {
    memDump((char*)dir, (char*)dump);
    return 0;
}

uint64_t getTime(uint64_t myDate, uint64_t secondP, uint64_t thirdP, uint64_t fourthP, uint64_t fifthP) {
    getLocalDate((date)myDate);
    return 0;
}

uint64_t setAlarmHandler(uint64_t function, uint64_t flag, uint64_t thirdP, uint64_t fourthP, uint64_t fifthP){
...
uint64_t psHandler(uint64_t firstP, uint64_t secondP, uint64_t thirdP, uint64_t fourthP, uint64_t fifthP){
    printProcesses();
    return 0;
}

uint64_t createProcessHandler(uint64_t entryPoint, uint64_t foreground, uint64_t thirdP, uint64_t fourthP,
                              uint64_t fifthP){
    return createProcess((uint64_t*)entryPoint, foreground, thirdP, fourthP, fifthP); //Falta agregar foreground en scheduler
}

uint64_t changeStateHandler(uint64_t pid, uint64_t state, uint64_t thirdP, uint64_t fourthP, uint64_t fifthP){
...
uint64_t getPidHandler(uint64_t firstP, uint64_t secondP, uint64_t thirdP, uint64_t fourthP, uint64_t fifthP){
    return getPid();
}

uint64_t getMemHandler(uint64_t size, uint64_t secondP, uint64_t thirdP, uint64_t fourthP, uint64_t fifthP){
    return mmMalloc(size);
}

uint64_t freeMemHandler(uint64_t ptr, uint64_t secondP, uint64_t thirdP, uint64_t fourthP, uint64_t fifthP) {
    mmFree((void*)ptr);
    return 0;
}
